            ...
            <Container>
                <div className={s.inner}>
                    ...
                    <div className={s.content}>
                            <ProfileSettingsCard
                                image={profile?.avatar?.url} firstName={profile?.first_name}
                                lastName={profile?.last_name} username={profile?.username}/>
                            <InfoSettingsCard firstName={profile?.first_name}
